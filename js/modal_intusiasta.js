/* ==============================================
   modal_intusiastas.js
   Incluir em: index.html  →  <script src="js/modal_intusiastas.js">
               pag2.html   →  <script src="../js/modal_intusiastas.js">
   ============================================== */

   (function () {

    /* ── 1. Injeta HTML do modal no body ── */
    const modalHTML = `
    ...
    /* ── 2. Detecta se está em /html/ (pag2) ou na raiz (index) ── */
    ...
    /* ── 4. Abre modal ao clicar em qualquer botão marcado com .btn-intusiastas ── */
    ...
    /* ── 5. Fecha ao clicar fora ou no X ── */
    ...
    /* ── 7. Enter dispara o botão ── */
    inputCpf.addEventListener("keydown", function (e) {
        if (e.key === "Enter") btnEntrar.click();
    });

    /* ── 8. Lógica ao clicar em Entrar ── */
    btnEntrar.addEventListener("click", function () {
        ...
        .then(dados => {
            ...
            if (dados.encontrado) {
                ...
                /* ✅ CPF cadastrado → salva e vai para entusiastas */
                ...
                /* ❌ CPF não cadastrado → avisa e manda para pag2 */
